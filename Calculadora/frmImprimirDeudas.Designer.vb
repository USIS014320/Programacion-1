...
Partial Class frmImprimirDeudas
    ...
    Private Sub InitializeComponent()
        ...
        'ReportViewer1
        '
        ReportDataSource1.Name = "ImprimirDeudas"
        ...
        '
        Me.ImprimirDeudasTableAdapter.ClearBeforeFill = True
        '
        'frmImprimirDeudas
        '
    ...
    Friend WithEvents ImprimirDeudasBindingSource As BindingSource
    Friend WithEvents bd_sigacDataSet As bd_sigacDataSet
    Friend WithEvents ImprimirDeudasTableAdapter As bd_sigacDataSetTableAdapters.ImprimirDeudasTableAdapter
End Class
