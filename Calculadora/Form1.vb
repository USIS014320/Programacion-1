Public Class Form1
    Private Sub btnProcesar_Click(sender As Object, e As EventArgs) Handles btnProcesar.Click
        ...
        lstEjercicios.Items.Add("Números pares del 1 al 20")
        For i = 2 To 20 Step 2
            lstEjercicios.Items.Add(i)

        Next

        lstEjercicios.Items.Add("Números impares del 1 al 20")
    ...
    Private Sub btnCajero_Click(sender As Object, e As EventArgs) Handles btnCajero.Click
        Dim denominaciones() = {100, 50, 20, 10, 5, 1, 0.5, 0.25, 0.1, 0.05, 0.01}, valor = txtnum1.Text, cantidad = 0
