Public Class Form1
    ...
    Private Sub btnConvertir_Click(sender As Object, e As EventArgs) Handles btnConvertir.Click
        txtRespuesta.Text = objConversor.convertir(cboTipo.SelectedIndex, cboDe.SelectedIndex, cboA.SelectedIndex, txtCantidad.Text).ToString() + " " + objConversor.etiquetas(cboTipo.SelectedIndex)(cboA.SelectedIndex)
    End Sub
